-- VERSION COMPLÈTE ET FONCTIONNELLE avec matching intelligent
...
BEGIN
  ...
  -- Retourner UNIQUEMENT les colonnes déclarées dans RETURNS TABLE
  SELECT 
  ...
  ORDER BY mp.zone_priority ASC, mp.rating DESC NULLS LAST
  ...
  ORDER BY fbp.rating DESC NULLS LAST
...
'Matching intelligent: Prestataires FIXES (GPS) + MOBILES (service_zones)';
